...
internal static class HttpExtensions
{
	...
	/// </summary>
	/// <remarks>
	/// The line format matches what the handler produced before redaction was added, so existing log
	/// output is unchanged apart from the credential values themselves.
	/// </remarks>
