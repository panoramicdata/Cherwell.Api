...
public partial class MobileCredentialsModeResponse : IEquatable<MobileCredentialsModeResponse>, IValidatableObject
{
	...
	public override bool Equals(object? obj)
	{
		...
		return Equals(obj as MobileCredentialsModeResponse);
	}
	...
	public bool Equals(MobileCredentialsModeResponse? other)
	{
		...
		return
				(
					CredentialsMode == other.CredentialsMode ||
					CredentialsMode != null &&
					CredentialsMode.Equals(other.CredentialsMode)
				) &&
				(
	...
	public override int GetHashCode()
	{
		...
		unchecked // Overflow is fine, just wrap
		{
			...
			{
				hash = hash * 59 + CredentialsMode.GetHashCode();
			}
