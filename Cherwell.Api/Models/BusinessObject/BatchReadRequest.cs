...
public partial class BatchReadRequest : IEquatable<BatchReadRequest>, IValidatableObject
{
	...
	public BatchReadRequest(List<ReadRequest> ReadRequests, bool? StopOnError = default)
	{
	...
	public override string ToString()
	{
		...
		sb.Append("class BusinessObjectBatchReadRequest {\n");
	...
	public override bool Equals(object? obj)
	{
		...
		return Equals(obj as BatchReadRequest);
	}

	/// <summary>
	/// Returns true if BusinessObjectBatchReadRequest instances are equal
	/// </summary>
