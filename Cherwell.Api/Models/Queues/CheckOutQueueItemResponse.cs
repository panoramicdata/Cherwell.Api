...
/// </summary>
[DataContract]
public partial class CheckOutQueueItemResponse : Response, IEquatable<CheckOutQueueItemResponse>, IValidatableObject
{
	/// <summary>
	...
	public CheckOutQueueItemResponse(string HistoryRecId, string HistoryText, string HistoryTypeId, string errorCode, string errorMessage, bool? hasError, EnumHttpStatusCode HttpStatusCode)
	{
	...
	public override string ToString()
	{
		...
		sb.Append("class QueuesCheckOutQueueItemResponse {\n");
	...
	public override bool Equals(object? obj)
	{
		...
		return Equals(obj as CheckOutQueueItemResponse);
	}
