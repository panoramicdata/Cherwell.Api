...
namespace Cherwell.Model.TrebuchetWebApiDataContracts;
{
    ...
    public partial class TrebuchetWebApiDataContractsUsersUserV2 :  IEquatable<TrebuchetWebApiDataContractsUsersUserV2>, IValidatableObject
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsUsersUserV2);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsUsersUserV2 instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsUsersUserV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsUsersUserV2 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
