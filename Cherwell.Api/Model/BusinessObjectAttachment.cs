...
namespace Cherwell.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectAttachment :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectAttachment>, IValidatableObject
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectAttachment);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectAttachment? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
