...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse" /> class.
        /// </summary>
        /// <param name="ErrorCode">ErrorCode.</param>
        /// <param name="ErrorMessage">ErrorMessage.</param>
        /// <param name="HasError">HasError.</param>
        /// <param name="HttpStatusCode">HttpStatusCode.</param>
        public TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsSaveTeamMemberResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
