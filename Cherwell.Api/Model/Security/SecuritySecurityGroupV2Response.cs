...
namespace Cherwell.Api.Model
{
    ...
    public partial class SecuritySecurityGroupV2Response :  IEquatable<SecuritySecurityGroupV2Response>, IValidatableObject
    {
        ...
        public SecuritySecurityGroupV2Response(List<SecuritySecurityGroup> SecurityGroups = default(List<SecuritySecurityGroup>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
