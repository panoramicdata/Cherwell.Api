...
namespace Cherwell.Api.Model
{
    ...
    public partial class SecurityRoleReadV2Response :  IEquatable<SecurityRoleReadV2Response>, IValidatableObject
    {
        ...
        public SecurityRoleReadV2Response(List<SecurityRole> Roles = default(List<SecurityRole>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
            this.Roles = Roles;
