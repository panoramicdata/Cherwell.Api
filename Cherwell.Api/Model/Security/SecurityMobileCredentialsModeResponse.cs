...
namespace Cherwell.Api.Model.Security
{
    ...
    public partial class SecurityMobileCredentialsModeResponse : IEquatable<SecurityMobileCredentialsModeResponse>, IValidatableObject
    {
        ...
        public SecurityMobileCredentialsModeResponse(int? CredentialsMode = default(int?), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
        ...
        public bool Equals(SecurityMobileCredentialsModeResponse? other)
        {
            ...
            return
                (
                    this.CredentialsMode == other.CredentialsMode ||
                    this.CredentialsMode != null &&
                    this.CredentialsMode.Equals(other.CredentialsMode)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CredentialsMode != null)
                    hash = hash * 59 + this.CredentialsMode.GetHashCode();
