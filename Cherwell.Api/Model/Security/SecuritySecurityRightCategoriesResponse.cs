...
namespace Cherwell.Api.Model
{
    ...
    public partial class SecuritySecurityRightCategoriesResponse :  IEquatable<SecuritySecurityRightCategoriesResponse>, IValidatableObject
    {
        ...
        public SecuritySecurityRightCategoriesResponse(List<SecurityRightCategory> RightCategories = default(List<SecurityRightCategory>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
        ...
        public bool Equals(SecuritySecurityRightCategoriesResponse? other)
        {
            ...
            return 
                (
                    this.RightCategories == other.RightCategories ||
                    this.RightCategories != null &&
                    this.RightCategories.SequenceEqual(other.RightCategories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RightCategories != null)
                    hash = hash * 59 + this.RightCategories.GetHashCode();
