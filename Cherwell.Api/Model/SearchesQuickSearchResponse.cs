...
namespace Cherwell.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsSearchesQuickSearchResponse :  IEquatable<TrebuchetWebApiDataContractsSearchesQuickSearchResponse>, IValidatableObject
    {
        ...
        public bool Equals(TrebuchetWebApiDataContractsSearchesQuickSearchResponse other)
        {
            ...
            return 
                (
                    this.SearchResultsTable == other.SearchResultsTable ||
                    this.SearchResultsTable != null &&
                    this.SearchResultsTable.Equals(other.SearchResultsTable)
                ) && 
                (
                    this.SimpleResultsList == other.SimpleResultsList ||
                    this.SimpleResultsList != null &&
                    this.SimpleResultsList.Equals(other.SimpleResultsList)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SearchResultsTable != null)
                    hash = hash * 59 + this.SearchResultsTable.GetHashCode();
                if (this.SimpleResultsList != null)
                    hash = hash * 59 + this.SimpleResultsList.GetHashCode();
