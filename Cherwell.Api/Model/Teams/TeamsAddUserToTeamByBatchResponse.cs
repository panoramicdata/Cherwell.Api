...
namespace Cherwell.Api.Model.Teams
{
    ...
    public partial class TeamsAddUserToTeamByBatchResponse :  IEquatable<TeamsAddUserToTeamByBatchResponse>, IValidatableObject
    {
        ...
        public TeamsAddUserToTeamByBatchResponse(List<TeamsAddUserToTeamResponse> Responses = default(List<TeamsAddUserToTeamResponse>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
