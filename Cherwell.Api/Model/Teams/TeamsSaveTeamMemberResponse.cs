...
namespace Cherwell.Api.Model.Teams
{
    ...
    public partial class TeamsSaveTeamMemberResponse :  IEquatable<TeamsSaveTeamMemberResponse>, IValidatableObject
    {
        ...
        public TeamsSaveTeamMemberResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
