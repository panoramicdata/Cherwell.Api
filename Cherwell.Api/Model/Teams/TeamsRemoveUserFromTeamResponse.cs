...
namespace Cherwell.Api.Model.Teams
{
    ...
    public partial class TeamsRemoveUserFromTeamResponse :  IEquatable<TeamsRemoveUserFromTeamResponse>, IValidatableObject
    {
        ...
        public TeamsRemoveUserFromTeamResponse(string TeamId = default(string), string UserRecordId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
            this.TeamId = TeamId;
