...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse" /> class.
        /// </summary>
        ...
        public TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse(string BusObId = default(string), string BusObRecId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse {\n");
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectBarcodeLookupResponse? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
