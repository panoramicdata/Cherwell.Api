...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse" /> class.
        /// </summary>
        ...
        public TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse(List<string> Values = default(List<string>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
            this.Values = Values;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse {\n");
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectFieldValuesLookupResponse? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
