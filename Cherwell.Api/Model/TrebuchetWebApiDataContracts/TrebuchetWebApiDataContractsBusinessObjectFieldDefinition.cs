...
namespace Cherwell.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectFieldDefinition :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectFieldDefinition>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectFieldDefinition);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectFieldDefinition instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectFieldDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectFieldDefinition other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
