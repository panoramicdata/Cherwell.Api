...
namespace Cherwell.Api.Model.Queues
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddItemToQueueResponse : IEquatable<AddItemToQueueResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public AddItemToQueueResponse(string HistoryRecId = default, string HistoryText = default, string HistoryTypeId = default, string ErrorCode = default, string ErrorMessage = default, bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as AddItemToQueueResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(AddItemToQueueResponse? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
