...
namespace Cherwell.Api.Model.Queues
{
    ...
    public partial class QueuesRemoveItemFromQueueResponse : IEquatable<QueuesRemoveItemFromQueueResponse>, IValidatableObject
    {
        ...
        public QueuesRemoveItemFromQueueResponse(string HistoryRecId = default(string), string HistoryText = default(string), string HistoryTypeId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
