...
namespace Cherwell.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectViewSummary :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectViewSummary>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectViewSummary);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectViewSummary instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectViewSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectViewSummary other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
