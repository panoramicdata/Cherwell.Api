...
namespace Cherwell.Api.Model.Lifecycle
{
    ...
    public partial class LifecycleGetStatusesResponse : IEquatable<LifecycleGetStatusesResponse>, IValidatableObject
    {
        ...
        public LifecycleGetStatusesResponse(List<LifecycleGetStatusesResponseStatuses> Statuses = default(List<LifecycleGetStatusesResponseStatuses>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
