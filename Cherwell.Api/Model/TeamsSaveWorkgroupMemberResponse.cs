...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse :  IEquatable<TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse" /> class.
        /// </summary>
        /// <param name="ErrorCode">ErrorCode.</param>
        /// <param name="ErrorMessage">ErrorMessage.</param>
        /// <param name="HasError">HasError.</param>
        /// <param name="HttpStatusCode">HttpStatusCode.</param>
        public TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse(string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsTeamsSaveWorkgroupMemberResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
