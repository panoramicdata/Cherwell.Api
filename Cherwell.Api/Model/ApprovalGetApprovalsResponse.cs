...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsApprovalGetApprovalsResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsApprovalGetApprovalsResponse :  IEquatable<TrebuchetWebApiDataContractsApprovalGetApprovalsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsApprovalGetApprovalsResponse" /> class.
        /// </summary>
        ...
        public TrebuchetWebApiDataContractsApprovalGetApprovalsResponse(int? TotalRecords = default(int?), List<TrebuchetWebApiDataContractsApprovalApprovalReadResponse> Approvals = default(List<TrebuchetWebApiDataContractsApprovalApprovalReadResponse>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public List<TrebuchetWebApiDataContractsApprovalApprovalReadResponse> Approvals { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsApprovalGetApprovalsResponse {\n");
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsApprovalGetApprovalsResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsApprovalGetApprovalsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsApprovalGetApprovalsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsApprovalGetApprovalsResponse? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Approvals != null &&
                    this.Approvals.SequenceEqual(other.Approvals)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Approvals != null)
                    hash = hash * 59 + this.Approvals.GetHashCode();
