...
public partial class BusinessObjectSaveUrlAttachmentRequest : IEquatable<BusinessObjectSaveUrlAttachmentRequest>, IValidatableObject
{
    ...
    public BusinessObjectSaveUrlAttachmentRequest(string BusObId = default(string), string BusObName = default(string), string BusObPublicId = default(string), string BusObRecId = default(string), string Comment = default(string), string DisplayText = default(string), bool? IncludeLinks = default(bool?), string Url = default(string))
    {
