...
namespace Cherwell.Model.BusinessObject
{
    ...
    public partial class BusinessObjectBarcodeLookupResponse : IEquatable<BusinessObjectBarcodeLookupResponse>, IValidatableObject
    {
        ...
        public BusinessObjectBarcodeLookupResponse(string BusObId = default(string), string BusObRecId = default(string), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
