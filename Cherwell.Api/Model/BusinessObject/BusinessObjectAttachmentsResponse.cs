...
namespace Cherwell.Api.Model.BusinessObject
{
    ...
    public partial class BusinessObjectAttachmentsResponse : IEquatable<BusinessObjectAttachmentsResponse>, IValidatableObject
    {
        ...
        public BusinessObjectAttachmentsResponse(List<BusinessObjectAttachment> Attachments = default(List<BusinessObjectAttachment>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), EnumHttpStatusCode? HttpStatusCode = default(EnumHttpStatusCode?))
        {
