...
namespace Cherwell.Api.Model.BusinessObject
{
    ...
    public partial class BusinessObjectAttachmentsResponse : IEquatable<BusinessObjectAttachmentsResponse>, IValidatableObject
    {
        ...
        public BusinessObjectAttachmentsResponse(List<BusinessObjectAttachment> Attachments = default(List<BusinessObjectAttachment>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BusinessObjectAttachmentsResponse {\n");
        ...
        /// <summary>
        /// Returns true if BusinessObjectAttachmentsResponse instances are equal
        /// </summary>
