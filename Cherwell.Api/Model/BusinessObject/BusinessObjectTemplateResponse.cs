...
namespace Cherwell.Api.Model.BusinessObject
{
    ...
    /// </summary>
    [DataContract]
    public partial class BusinessObjectTemplateResponse : IEquatable<BusinessObjectTemplateResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessObjectTemplateResponse" /> class.
        /// </summary>
        ...
        public BusinessObjectTemplateResponse(List<BusinessObjectFieldTemplateItem> Fields = default(List<BusinessObjectFieldTemplateItem>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
            this.Fields = Fields;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BusinessObjectTemplateResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BusinessObjectTemplateResponse);
        }

        /// <summary>
        /// Returns true if BusinessObjectTemplateResponse instances are equal
        /// </summary>
