...
namespace Cherwell.Model
{
    ...
    public partial class TrebuchetWebApiDataContractsBusinessObjectRelationship :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectRelationship>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectRelationship);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectRelationship instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectRelationship to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectRelationship other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
