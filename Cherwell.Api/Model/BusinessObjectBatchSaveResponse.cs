...
{
    /// <summary>
    /// TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse
    /// </summary>
    [DataContract]
    public partial class TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse :  IEquatable<TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse" /> class.
        /// </summary>
        ...
        public TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse(List<TrebuchetWebApiDataContractsBusinessObjectSaveResponse> Responses = default(List<TrebuchetWebApiDataContractsBusinessObjectSaveResponse>), string ErrorCode = default(string), string ErrorMessage = default(string), bool? HasError = default(bool?), HttpStatusCodeEnum? HttpStatusCode = default(HttpStatusCodeEnum?))
        {
        ...
        public List<TrebuchetWebApiDataContractsBusinessObjectSaveResponse> Responses { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse {\n");
        ...
        public override bool Equals(object? obj)
        {
            ...
            return this.Equals(obj as TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse);
        }

        /// <summary>
        /// Returns true if TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrebuchetWebApiDataContractsBusinessObjectBatchSaveResponse? other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
