...
namespace Cherwell.Api.Interfaces;
    ...
    public interface IOneStepActionsApi
    {
        ...
        Task<ManagerData> GetOneStepActionsByAssociationScopeScopeOwnerAsync([Header("UserAgent")] string userAgent, [AliasAs("association")]string association, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetOneStepActionsByAssociationScopeAsync([Header("UserAgent")] string userAgent, [AliasAs("association")]string association, [AliasAs("scope")]string scope, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetOneStepActionsByAssociationAsync([Header("UserAgent")] string userAgent, [AliasAs("association")]string association, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetOneStepActionsAsync([Header("UserAgent")] string userAgent, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<OneStepActionResponse> RunOneStepActionByKeyForRecordByRecIdAsync([Header("UserAgent")] string userAgent, [AliasAs("standinkey")]string standinkey, [AliasAs("busobid")]string busobid, [AliasAs("busobrecid")]string busobrecid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<OneStepActionResponse> RunOneStepActionByStandInKeyAsync([Header("UserAgent")] string userAgent, [AliasAs("standinkey")]string standinkey, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<OneStepActionResponse> RunOneStepActionAsync([Header("UserAgent")] string userAgent, [Body]OneStepActionRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
