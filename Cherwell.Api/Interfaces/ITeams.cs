...
namespace Cherwell.Api.Interfaces;
    ...
    public interface ITeamsApi
    {
        ...
        Task<AddUserToTeamByBatchResponse> AddUserToTeamByBatchAsync([Header("UserAgent")] string userAgent, [Body]AddUserToTeamByBatchRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task AddUserToTeamAsync([Header("UserAgent")] string userAgent, [Body]AddUserToTeamRequest dataRequest, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<AddUserToTeamResponse> AddUserToTeamV2Async([Header("UserAgent")] string userAgent, [Body]AddUserToTeamRequest dataRequest, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task DeleteTeamAsync([Header("UserAgent")] string userAgent, [AliasAs("teamid")]string teamid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamResponse> GetTeamAsync([Header("UserAgent")] string userAgent, [AliasAs("teamid")]string teamid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        [Get("/api/V1/getteams")]
        Task<TeamsResponse> GetTeamsAsync([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        [Get("/api/V2/getteams")]
        Task<TeamsV2Response> GetTeamsV2Async([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamsResponse> GetUsersTeamsAsync([Header("UserAgent")] string userAgent, [AliasAs("userRecordId")]string userRecordId, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamsV2Response> GetUsersTeamsV2Async([Header("UserAgent")] string userAgent, [AliasAs("userRecordId")]string userRecordId, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamsResponse> GetWorkgroupsAsync([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamsV2Response> GetWorkgroupsV2Async([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<RemoveCustomerFromWorkgroupResponse> TeamsRemoveCustomerFromWorkgroupAsync([Header("UserAgent")] string userAgent, [AliasAs("workgroupid")]string workgroupid, [AliasAs("customerrecordid")]string customerrecordid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task RemoveUserFromTeamAsync([Header("UserAgent")] string userAgent, [AliasAs("teamId")]string teamId, [AliasAs("userrecordid")]string userrecordid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<RemoveUserFromTeamResponse> RemoveUserFromTeamV2Async([Header("UserAgent")] string userAgent, [AliasAs("teamId")]string teamId, [AliasAs("userrecordid")]string userrecordid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<SaveTeamMemberResponse> SaveTeamMemberAsync([Header("UserAgent")] string userAgent, [Body]SaveTeamMemberRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<TeamSaveResponse> SaveTeamAsync([Header("UserAgent")] string userAgent, [Body]TeamSaveRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<SaveWorkgroupMemberResponse> SaveWorkgroupMemberAsync([Header("UserAgent")] string userAgent, [Body]SaveWorkgroupMemberRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
