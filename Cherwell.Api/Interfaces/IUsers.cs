...
namespace Cherwell.Api.Interfaces;
    ...
    public interface IUsersApi
    {
        ...
        Task<UserBatchDeleteResponse> DeleteUserBatchAsync([Header("UserAgent")] string userAgent, [Body]UserBatchDeleteRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserBatchDeleteV2Response> DeleteUserBatchV2Async([Header("UserAgent")] string userAgent, [Body]UserBatchDeleteRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserDeleteResponse> DeleteUserAsync([Header("UserAgent")] string userAgent, [AliasAs("userrecordid")]string userrecordid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserDeleteV2Response> DeleteUserV2Async([Header("UserAgent")] string userAgent, [AliasAs("userrecordid")]string userrecordid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserListResponse> GetListOfUsersAsync([Header("UserAgent")] string userAgent, [AliasAs("loginidfilter")]string loginidfilter, [AliasAs("stoponerror")]bool? stoponerror, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserBatchReadResponse> GetUserBatchAsync([Header("UserAgent")] string userAgent, [Body]UserBatchReadRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<User> GetUserByLoginIdAsync([Header("UserAgent")] string userAgent, [AliasAs("loginid")]string loginid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<User> GetUserByLoginIdV2Async([Header("UserAgent")] string userAgent, [AliasAs("loginid")]string loginid, [AliasAs("loginidtype")]string loginidtype, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserV2> GetUserByLoginIdV3Async([Header("UserAgent")] string userAgent, [AliasAs("loginid")]string loginid, [AliasAs("loginidtype")]string loginidtype, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserReadResponse> GetUserByPublicIdAsync([Header("UserAgent")] string userAgent, [AliasAs("publicid")]string publicid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserReadV2Response> GetUserByPublicIdV2Async([Header("UserAgent")] string userAgent, [AliasAs("publicid")]string publicid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserV2> GetUserByRecIdAsync([Header("UserAgent")] string userAgent, [AliasAs("recid")]string recid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserBatchSaveResponse> SaveUserBatchAsync([Header("UserAgent")] string userAgent, [Body]UserBatchSaveRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserBatchSaveV2Response> SaveUserBatchV2Async([Header("UserAgent")] string userAgent, [Body]UserBatchSaveV2Request request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserSaveResponse> SaveUserAsync([Header("UserAgent")] string userAgent, [Body]UserSaveRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<UserSaveV2Response> SaveUserV2Async([Header("UserAgent")] string userAgent, [Body]UserSaveV2Request request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
