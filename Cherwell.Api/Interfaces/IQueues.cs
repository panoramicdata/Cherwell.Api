...
namespace Cherwell.Api.Interfaces;
    ...
    public interface IQueuesApi
    {
        ...
        Task<AddItemToQueueResponse> AddItemToQueueAsync([Header("UserAgent")] string userAgent, [Body]AddItemToQueueRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<CheckInQueueItemResponse> CheckInQueueItemAsync([Header("UserAgent")] string userAgent, [Body]CheckInQueueItemRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<CheckOutQueueItemResponse> CheckOutQueueItemAsync([Header("UserAgent")] string userAgent, [Body]CheckOutQueueItemRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetQueuesFolderAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("folder")]string folder, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetQueuesScopeOwnerAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetQueuesScopeAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetQueuesAsync([Header("UserAgent")] string userAgent, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<RemoveItemFromQueueResponse> RemoveItemFromQueueAsync([Header("UserAgent")] string userAgent, [Body]RemoveItemFromQueueRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
