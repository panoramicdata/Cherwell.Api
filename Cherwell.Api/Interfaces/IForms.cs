...
namespace Cherwell.Api.Interfaces;
    ...
    public interface IFormsApi
    {
        ...
        Task<MobileFormResponse> GetMobileFormForBusObByIdAndPublicIdAsync([Header("UserAgent")] string userAgent, [AliasAs("busobid")]string busobid, [AliasAs("publicid")]string publicid, [AliasAs("foredit")]bool? foredit, [AliasAs("formid")]string formid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<MobileFormResponse> GetMobileFormForBusObByIdAndRecIdAsync([Header("UserAgent")] string userAgent, [AliasAs("busobid")]string busobid, [AliasAs("busobrecid")]string busobrecid, [AliasAs("foredit")]bool? foredit, [AliasAs("formid")]string formid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<MobileFormResponse> GetMobileFormForBusObByNameAndPublicIdAsync([Header("UserAgent")] string userAgent, [AliasAs("busobname")]string busobname, [AliasAs("publicid")]string publicid, [AliasAs("foredit")]bool? foredit, [AliasAs("formid")]string formid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<MobileFormResponse> GetMobileFormForBusObByNameAndRecIdAsync([Header("UserAgent")] string userAgent, [AliasAs("busobname")]string busobname, [AliasAs("busobrecid")]string busobrecid, [AliasAs("foredit")]bool? foredit, [AliasAs("formid")]string formid, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
