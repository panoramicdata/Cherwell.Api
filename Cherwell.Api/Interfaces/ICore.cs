...
namespace Cherwell.Api.Interfaces;
    ...
    public interface ICoreApi
    {
        ...
        Task DeleteGalleryImageByStandInKeyAsync([Header("UserAgent")] string userAgent, [AliasAs("standinkey")]string standinkey, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<string> GetGalleryImageAsync([Header("UserAgent")] string userAgent, [AliasAs("name")]string name, [AliasAs("width")]int? width, [AliasAs("height")]int? height, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetGalleryImagesFolderAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("folder")]string folder, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetGalleryImagesScopeOwnerAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetGalleryImagesScopeAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetGalleryImagesAsync([Header("UserAgent")] string userAgent, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<StoredValueResponse> GetStoredValueAsync([Header("UserAgent")] string userAgent, [AliasAs("standInKey")]string standInKey, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetStoredValuesFolderAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("folder")]string folder, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetStoredValuesScopeOwnerAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("scopeowner")]string scopeowner, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetStoredValuesScopeAsync([Header("UserAgent")] string userAgent, [AliasAs("scope")]string scope, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ManagerData> GetStoredValuesAsync([Header("UserAgent")] string userAgent, [AliasAs("links")]bool? links, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        [Get("/api/V1/getviews")]
        Task<ViewsResponse> GetViewsAsync([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<SaveGalleryImageResponse> SaveGalleryImageAsync([Header("UserAgent")] string userAgent, [Body]SaveGalleryImageRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<StoredValueResponse> SaveStoredValueAsync([Header("UserAgent")] string userAgent, [Body]SaveStoredValueRequest request, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<string> SetCultureAsync([Header("UserAgent")] string userAgent, [AliasAs("culturecode")]string culturecode, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
