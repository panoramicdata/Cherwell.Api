...
namespace Cherwell.Api.Interfaces;
    ...
    public interface IApprovalApi
    {
        ...
        Task<SaveResponse> ActionApprovalAsync([Header("UserAgent")] string userAgent, [AliasAs("approvalRecId")]string approvalRecId, [AliasAs("approvalAction")]string approvalAction, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<ApprovalReadResponse> GetApprovalByRecIdAsync([Header("UserAgent")] string userAgent, [AliasAs("approvalRecId")]string approvalRecId, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<GetApprovalsResponse> GetMyApprovalsAsync([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
        ...
        Task<GetApprovalsResponse> GetMyPendingApprovalsAsync([Header("UserAgent")] string userAgent, [AliasAs("lang")]string lang, [AliasAs("locale")]string locale);
